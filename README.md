Welcome to the Wally the Worm mod! This file contains mod installation requirements, how to set it up and most importantly: A changelog!

<img width="321" height="321" alt="Frontfacing Wally" src="https://github.com/user-attachments/assets/27cfe044-59e8-4f5a-aa7b-72bd4191cc43" />
...
- A good device (mobile or pc, doesn't matter).

## Setup (for dummies):
- Download mod;
- Unzip mod (important);
- Put mod in 'mods' folder;
- If no 'mods' folder, make new folder called 'mods';
- Open Funkin.exe (or FNF on mobile).
- Have fun!

The mod is cross-platform, meaning it works on both PC and mobile devices (Android/iOS), without having to download separate versions.
...
- Camera now also zooms out when focused on GF in Devastation, in the cheering part.
...
- (Easy/Normal/Hard) A note in the first "Yeah!" part in Devastation no longer plays a sing animation.
